...
internal sealed record DesktopSettings(string Host, int TcpPort, int McpPort, bool StartMinimized)
{
    public static DesktopSettings Current { get; private set; } = new("127.0.0.1", 9399, 9401, false);
    ...
    public static void Configure(string[] args)
    {
        ...
        Current = new DesktopSettings(host, tcpPort, mcpPort, startMinimized);
    }
}
